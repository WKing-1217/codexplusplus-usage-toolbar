...
**版本：1.0.7。** 独立用户脚本项目，依赖 Codex++ 的脚本加载功能，不是 Codex++ 客户端分发包，也不是 OpenAI 官方扩展。
...
1. 已安装上表所列版本的 Codex++。
2. 从 [最新发布页](https://github.com/WKing-1217/codexplusplus-usage-toolbar/releases/latest) 下载 `codexplusplus-usage-toolbar-v1.0.7.zip`，**先完整解压**。
...
1. 确认重新加载脚本后底部显示 **1.0.7**。仍显示旧版本号，说明窗口还在运行旧脚本。
